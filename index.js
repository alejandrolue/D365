...
$(document).ready(function() {
    $(document).on("click","#TSTimesheetTable_TimesheetNbr_GridView_3_0_0_input",function() {
      waitForElm(".multilineInput-textArea").then((elm) => {
        ...
        document.getElementsByClassName("multilineInput-textArea").TSTimesheetLineWeek_ExternalComments.onchange = function() {getValue()};
        ...
        document.getElementsByClassName("multilineInput-textArea").TSTimesheetLineWeek_ExternalComments.onchange = function() {
          ...
          document.getElementById("You're_welcome_Boris").onchange = function() {onSelect()};
        };

        document.getElementById("You're_welcome_Boris").onchange = function() {onSelect()};
        document.getElementById("You're_welcome_Janes").onchange = function() {onDeleteSelect()};
      ...
      console.log("delete");
      var getField = document.getElementById("delete");
      for (var i = 0; getField.length > i; i++) {
          if (getField.options[i].value === document.getElementById("You're_welcome_Janes").value);
          getField.remove(i);
      }
